# Plantilla Tesis UNPRG

---

** [`#UNPRG`](#UNPRG) [`#FICSA`](#FICSA) [`#tesis`](#tesis) [`#EPIS`](#EPIS) [`#LaTex`](#LaTex)**

Plantilla de tesis de la Universidad Nacional Pedro Ruiz Gallo (UNPRG), Facultad de Ingeniería Civil, de Sistemas y Arquitectura (FICSA). Escuela Profesional de Ingeniería de Sistemas (EPIS).

Este proyecto es una versión de la plantilla creada por Pedro Pernías de la Escuela Politécnica Superior de la Universidad de Alicante. <a href="https://www.overleaf.com/latex/templates/plantilla-latex-v2019-tfg-y-tfm-para-la-eps-de-la-universidad-de-alicante/zrvfhcndfptf">Plantilla Overleaf</a> 
...
La plantilla respeta las directrices de estilo que determina la Universidad Nacional Pedro Ruiz Gallo.
