...
\definecolor{sistemas}{RGB}{3,71,161}		% SISTEMAS-UNPRG {2,131,214}

% Logotipos comunes de todas las titulaciones
\newcommand{\logoFacultad}{include/logos-universidad/LogoFICSAExtended}
\newcommand{\logoFacultadOriginal}{include/logos-universidad/LogoFICSAColor}
\newcommand{\logoUniversidad}{include/logos-universidad/LogoUNPRGExtended}
\newcommand{\logoUniversidadPortada}{include/logos-universidad/LogoUNPRGBlancoExtended}
\newcommand{\logoUniversidadPortadaOriginal}{include/logos-universidad/LogoUNPRGColor}
...
% Grados
	...
	\else \if\IDtitulo 8 % Robotica
		...
		\newcommand{\colortexto}{negro}
	\else \if\IDtitulo 9 % Sistemas
		% Logos
		\newcommand{\logoFacultadPortada}{include/logos-universidad/LogoFICSABlancoExtended}
		\newcommand{\logoGradoPortada}{include/logos-titulaciones/LogoInformaticaBlanco}
		\newcommand{\logoGrado}{include/logos-titulaciones/LogoInformaticaNegro}
		% Texto
		\newcommand{\miGrado}{Título Profesional de Ingeniero de Sistemas}
		\newcommand{\tipotrabajo}{Tesis de Título}
		% Color
		\newcommand{\colorgrado}{sistemas}
		\newcommand{\colortexto}{blanco}
% Másteres
