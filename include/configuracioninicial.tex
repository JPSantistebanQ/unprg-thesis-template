...
\documentclass[a4paper,11pt,titlepage,table,xcdraw,dvipsnames,openany]{scrbook}
\KOMAoption{toc}{bib,chapterentryfill} % Opciones del índice
\usepackage{scrhack} % Previene algunos errores
\usepackage{changepage} % Márgenes
...
\definecolor{bblue}{HTML}{407fc9}
\definecolor{rred}{HTML}{d64440}
\definecolor{ggreen}{HTML}{9bc742}
\definecolor{ppurple}{HTML}{b0387d}
\definecolor{GrisDark}{rgb}{.2,.2,.2}
%%%%%%%%%%%%%%%%%%%%%%%%
% TABLAS
%%%%%%%%%%%%%%%%%%%%%%%%
...
\usepackage{tikz,tikzpagenodes, pgf-pie}
...
\usepackage{booktabs,threeparttable} % By JP
\usepackage{siunitx} % By JP
...
% Capítulos en Figuras y Tablas en Arabic BY JP
\def\thefigure{\arabic{chapter}.\@arabic\c@figure}
\renewcommand*{\figureformat}{\figurename~\thefigure}

\def\thetable{\arabic{chapter}.\@arabic\c@table}
...
\newcommand\feline@chapter@marker[1][2cm]{%
	\sbox\feline@chapter{%
		\resizebox{!}{#1}{\setlength{\fboxsep}{2pt}%
			\colorbox{white}{\color{GrisDark}$\eurom\thechapter$}}}%
	\raisebox{\depth}{\usebox{\feline@chapter}}%
}
\renewcommand*{\chapterformat}{%
	\sbox\feline@chapter{\feline@chapter@marker[2.5cm]}%
	\makebox[0pt][l]{%
		\makebox[\dimexpr\textwidth-3.2cm+\wd\feline@chapter\relax][r]{%
...
\preto\chapterheadendvskip{%
	\vspace*{-\parskip}%
	{\noindent\setlength\parfillskip{0pt plus 1fil}\rule{\textwidth}{1.7pt}\par}%
}

%% PARA APÉNDICES
\usepackage{scrwfile}

\TOCclone[Lista de Apéndices]{toc}{atoc}
...
%%PARA LOS TEXTOS AUTOGENERADOS - LOREM
\usepackage{lipsum}  